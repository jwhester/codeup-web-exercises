...
$(document).ready(function() {
	...
	$('.container').css({"font-family": "Comic Sans MS", "background-color": "yellow"});
	...
	$('.main-headings').css("font-size", "30px");
	...
	$('p').css("background-color","limegreen");
	...
	$("#mystery-genre, #book-bundle-three").css('background-color', 'lawngreen');
