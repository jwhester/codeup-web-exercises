...
var codeupPopup = new mapboxgl.Popup({className: 'blue'})
    .setHTML("<p>Home</p>")
    .addTo(map);
...
geocode('879 County Road 679, Natalia, Tx 78059', mapboxToken).then(function(result) {
    console.log(result);
...
reverseGeocode({lng: -88.4861, lat: 79.4260}, mapboxToken).then(function(results) {
